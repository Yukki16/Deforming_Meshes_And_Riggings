...
public class DepthRendererFeature : ScriptableRendererFeature {
    ...
    public class DepthRenderPass : ScriptableRenderPass {
        ...
        public DepthRenderPass(Settings settings, string name) {
        ...
        name: settings.depthTargetDestinationID);
            ...
            ConfigureClear(ClearFlag.Depth, new Color(0,0,0,0));
        }
    ...
    public class Settings {
        ...
        public List<Renderer> subtractees;
    }
    ...
    public override void Create() {
        m_ScriptablePass = new DepthRenderPass(settings, name);
